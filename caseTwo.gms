...
objective_function .. cost =e= sum((w,t),((buy_price(t)*power_grid_input(w,t)*time_interval)-(sell_price(t)*power_grid_output(w,t)*time_interval)));
...
pv(w,t) .. power_used_pv(w,t) + power_sold_pv(w,t) =e= power_produced_pv(t,w) * 0;

*** wind production ***

wind(w,t) .. power_used_wind(w,t) + power_sold_wind(w,t) =e= power_produced_wind(t,w) * 0;
...
* execute 'gdxxrw.exe results.gdx squeeze=n intAsText=n var=cost.l rng=cost!'
